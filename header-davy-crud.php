...
<html lang="fr">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?= URL ?>/images/logo-icon-min.png">
        <link rel="stylesheet" href="<?= URL ?>/css/style_bootstrap_grid.min.css">
        <link rel="stylesheet" href="<?= URL ?>/css/style_nav_mobile.css">
        <link rel="stylesheet" href="<?= URL ?>/css/style_bouton.css">
...
?>
                <a href="<?= URL ?>/gestion-davy-crud.php?table=<?= $table_data_base['TABLE_NAME'] ?>" class="lien_admin_davy" title="<?= $table_data_base['TABLE_NAME'] ?>">
...
?>
            ...
            <div class="nav_mobile_burger_davy">
                <div class="m-5">
                    ...
                    <hr class="hr_admin_davy">
                    <a href="" title="Dashboard" class="d-inline-block width_full_davy lien_dashboard">Dashboard</a>
                    <hr class="hr_admin_davy">
<?php
$pdo_statement_base = $pdo_object->prepare("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE='BASE TABLE' AND TABLE_SCHEMA='$bdd_name'");
$pdo_statement_base->execute();
while ($table_data_base = $pdo_statement_base->fetch(PDO::FETCH_ASSOC)) :
?>
                    <a href="<?= URL ?>/gestion-davy-crud.php?table=<?= $table_data_base['TABLE_NAME'] ?>" title="<?= $table_data_base['TABLE_NAME'] ?>" class="d-inline-block width_full_davy lien_<?= $table_data_base['TABLE_NAME'] ?>"><?= $table_data_base['TABLE_NAME'] ?></a>
                    <hr class="hr_admin_davy">
<?php
endwhile;
?>
                    <a href="" title="Mail" class="d-inline-block width_full_davy lien_mail">Mail</a>
                    <hr class="hr_admin_davy">
                    <a href="" title="Comptes" class="d-inline-block width_full_davy lien_gestion_comptes">Comptes</a>
                    <hr class="hr_admin_davy">
                    <form method="post" id="bouton_deconnecter_davy">
                        <!-- bouton_anim_davy -->
                        <a aria-label="Quitter" class="bouton_anim_davy bouton_envoyer width_full_davy bouton_full_davy" data-text="Déconnecter" title="Déconnecter">
