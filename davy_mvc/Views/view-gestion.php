        ...
        <div class="block_admin_davy container">
            <div class="row">
                <div class="col text_center_davy">
                    ...
                    <!-- bouton_anim_davy -->
                    <a href="<?= URL ?>/ajouter.php?&table=<?= $bdd_table ?>" aria-label="élément" class="bouton_anim_davy bouton_envoyer" data-text="Ajouter" title="Ajouter">
                        <span>é</span>
                        <span>l</span>
                        <span>é</span>
                        <span>m</span>
...
?>
        ...
        $(document).ready(function() {
            $("#mot_chercher").keyup(function() {
                let str_load = "<?= URL ?>/gestion-ajax.php?chercher=" + $("#mot_chercher").val() + "&table=<?= $bdd_table ?>";
