...
<html lang="fr">
    <head>
        ...
        <title>Davy CHEN</title>
        <meta name="description" content="Davy CHEN">
        ...
        <link rel="stylesheet" href="<?= URL ?>/Views/css/style_animation_scroll.css">
        <link rel="stylesheet" href="<?= URL ?>/Views/css/style_animation_scroll_header.css">
